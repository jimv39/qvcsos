...
public class OperationLockArchive extends OperationBaseClass {
     ...
     */
    OperationLockArchive(JTable fileTable, final String serverName, final String projectName, final String viewName, UserLocationProperties userLocationProperties,
                         boolean flag) {
    ...
    void completeOperation(final List mergedInfoArray, final LogFileOperationLockRevisionCommandArgs commandArgs) {
