...
public abstract class OperationBaseClass {
    ...
    abstract void executeOperation();
    ...
    static ProgressDialog createProgressDialog(final String progressAction, final int size) {
    ...
    static void initProgressDialog(final String action, final int min, final int max, final ProgressDialogInterface progressDialog) {
    ...
    static void updateProgressDialog(final int i, final String activity, final ProgressDialogInterface progressDialog) {
        // Update the progress monitor
        Runnable later = new Runnable() {

            @Override
            public void run() {
                if ((i > MINIMUM_TO_SHOW_PROGRESS) && !progressDialog.getProgressDialogVisibleFlag()) {
    ...
    static ParentChildProgressDialog createParentProgressDialog(final String progressAction, final int size) {
    ...
    static void updateParentChildProgressDialog(final int i, final String activity, final ParentProgressDialogInterface progressDialog) {
        // Update the progress monitor
        Runnable later = new Runnable() {
