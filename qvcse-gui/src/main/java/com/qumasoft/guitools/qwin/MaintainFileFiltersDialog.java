    ...
    {//GEN-HEADEREND:event_newCollectionButtonActionPerformed
        ...
        if (defineFilterCollectionNameDialog.getCollectionName() != null) {
            ...
            if (alreadyUsedFlag == false) {
                ...
                // By default, all new filter collections exclude obsolete files.
                // The user can manually remove this filter if they want to see obsolete files.
                FileFilterExcludeObsoleteFilter excludeObsoleteFilter = new FileFilterExcludeObsoleteFilter(true);
                newCollection.addFilter(excludeObsoleteFilter);
