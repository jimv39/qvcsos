...
public class OperationCreateArchive extends OperationBaseClass {
     ...
     */
    OperationCreateArchive(JTable fileTable, final String serverName, final String projectName, final String viewName, UserLocationProperties userLocationProperties,
                           boolean flag) {
    ...
    void completeOperation(final List mergedInfoArray, final LogFileOperationCreateArchiveCommandArgs commandArgs) {
