...
public class FileFilterExcludeRevisionDescriptionRegExpressionFilter extends AbstractFileFilter {
    ...
    FileFilterExcludeRevisionDescriptionRegExpressionFilter(String regularExpression, boolean isANDFilter, Integer id) {
        super(isANDFilter, id, CommonFilterFile.EXCLUDE_REGEX_REV_DESCRIPTION);
        try {
