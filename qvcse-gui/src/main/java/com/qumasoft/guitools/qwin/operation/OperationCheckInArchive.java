...
public class OperationCheckInArchive extends OperationBaseClass {
     ...
     */
    public OperationCheckInArchive(JTable fileTable, final String serverName, final String projectName, final String branchName, RemotePropertiesBaseClass remoteProperties) {
    ...
    public void processDialogResult(final List<MergedInfoInterface> mergedInfoArray, final CheckInDialog checkIn) {
        ...
        new Thread(worker, "OperationCheckinArchive186").start();
    }
}
