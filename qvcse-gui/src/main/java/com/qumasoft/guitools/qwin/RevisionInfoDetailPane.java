 ...
 * @author Jim Voris
 */
public final class RevisionInfoDetailPane extends javax.swing.JPanel {
     ...
     */
    public RevisionInfoDetailPane() {
        initComponents();
        getList().setCellRenderer(new RevisionInfoCellRenderer());
    }
    ...
    static class RevisionInfoCellRenderer extends JLabel implements ListCellRenderer {
