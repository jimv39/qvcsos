...
public class OperationCompareRevisions extends OperationBaseClass {
     ...
     */
    public OperationCompareRevisions(JTable fileTable, final String serverName, final String projectName, final String branchName, RemotePropertiesBaseClass remoteProperties) {
