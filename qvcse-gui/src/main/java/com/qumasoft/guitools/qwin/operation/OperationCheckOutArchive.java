...
public class OperationCheckOutArchive extends OperationBaseClass {
     ...
     */
    public OperationCheckOutArchive(JTable fileTable, final String serverName, final String projectName, final String branchName, UserLocationProperties userLocationProperties,
                             boolean flag) {
