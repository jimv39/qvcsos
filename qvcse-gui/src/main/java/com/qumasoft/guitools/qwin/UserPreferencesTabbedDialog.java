...
// <editor-fold defaultstate="collapsed" desc="Generated Code">//GEN-BEGIN:initComponents
    private void initComponents() {
        ...
        byPassLoginCheckBox.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        byPassLoginCheckBox.setText("Bypass login dialog.");
        byPassLoginCheckBox.setToolTipText("Enable to bypass the login dialog");
                ...
                .add(generalPanelLayout.createSequentialGroup()
                        ...
                        .add(generalPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                .add(generalPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                                        .add(org.jdesktop.layout.GroupLayout.LEADING, byPassLoginCheckBox, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setHorizontalGroup(
                ...
                .add(tabbedPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 389, Short.MAX_VALUE)
    ...
    {//GEN-HEADEREND:event_okButtonActionPerformed
        ...
        if (autoUpdateInterval != currentAutoUpdateInterval) {
            QWinFrame.getQWinFrame().getUserProperties().setAutoUpdateInterval(autoUpdateInterval);
        }
        ...
        if ((autoUpdateFlag != currentAutoUpdateFlag)
            ...
            QWinFrame.getQWinFrame().getUserProperties().setAutoUpdateFlag(autoUpdateFlag);
        ...
        boolean bypassLoginDialogFlag = getBypassLoginDialogFlag();
        ...
        if (ignoreHiddenDirectoriesFlag != currentIgnoreHiddenDirectoriesFlag) {
            QWinFrame.getQWinFrame().getUserProperties().setIgnoreHiddenDirectoriesFlag(ignoreHiddenDirectoriesFlag);
        }
        ...
        if (!currentLookAndFeel.equals(getLookAndFeelString())) {
            QWinFrame.getQWinFrame().getUserProperties().setLookAndFeel(getLookAndFeelClassNameString());
    ...
    private void populateComponents() {
        ...
        currentFontSize = userProperties.getFontSize();
        fontSizeSpinner.setValue(Integer.valueOf(userProperties.getFontSize()));
        ...
        // External visual command flag
        // External visual command command line.
        String commandLine = userProperties.getExternalVisualCommandLine();
        boolean flag = userProperties.getUseExternalVisualCompareTool();
    ...
    private boolean getBypassLoginDialogFlag() {
        return byPassLoginCheckBox.isSelected();
    }
