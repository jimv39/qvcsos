...
public class FilteredRevisionInfo {
    ...
    /**
     * Get the mergedInfo for this filtered revision.
     * @return the mergedInfo for this filtered revision.
     */
    public MergedInfoInterface getMergedInfo() {
        return mergedInfo;
    }
     ...
     */
    public RevisionHeader getRevisionHeader() {
