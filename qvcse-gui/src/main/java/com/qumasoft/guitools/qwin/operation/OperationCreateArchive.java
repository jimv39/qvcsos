...
public class OperationCreateArchive extends OperationBaseClass {
     ...
     */
    public OperationCreateArchive(JTable fileTable, final String serverName, final String projectName, final String branchName, RemotePropertiesBaseClass remoteProperties,
                           boolean flag) {
    ...
    public void completeOperation(final List mergedInfoArray, final CreateArchiveCommandArgs commandArgs) {
        ...
        new Thread(worker, "OperationCreateArchive150").start();
    }
}
