...
/**
 * Checked in after commit id revision filter.
 *
 * @author Jim Voris
 */
public class RevisionFilterCheckedInAfterCommitFilter extends AbstractRevisionFilter {
     ...
     */
    public RevisionFilterCheckedInAfterCommitFilter(String commitIdString, boolean isANDFilter) {
        super(isANDFilter);
        try {
    ...
    public boolean equals(Object o) {
        boolean retVal = false;
        if (o instanceof RevisionFilterCheckedInAfterCommitFilter) {
            RevisionFilterCheckedInAfterCommitFilter filter = (RevisionFilterCheckedInAfterCommitFilter) o;
    ...
    public int hashCode() {
        // <editor-fold>
        int hash = 5;
        hash = 97 * hash + Objects.hashCode(this.filterCommitId);
