 ...
 * @author Jim Voris
 */
public class FileFilterFilesizeGreaterThanFilter extends AbstractFileFilter {
    private static final long serialVersionUID = -1052955846785833204L;

    private long filterFilesize;

    FileFilterFilesizeGreaterThanFilter(String size, boolean isANDFilter, Integer id) {
        super(isANDFilter, id, CommonFilterFile.FILESIZE_GREATER_THAN);
        try {
    ...
    public String getFilterType() {
        return QVCSConstants.FILESIZE_GREATER_THAN_FILTER;
    }
