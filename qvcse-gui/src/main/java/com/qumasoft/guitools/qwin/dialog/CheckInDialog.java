...
public final class CheckInDialog extends AbstractQWinCommandDialog {
     ...
     * @param checkInCommentList
     * @param modal is this modal.
     * @param operation the check in operation that will do the work.
     */
    public CheckInDialog(java.awt.Frame parent, List<MergedInfoInterface> files, List<String> checkInCommentList, boolean modal, OperationCheckInArchive operation) {
        super(parent, modal);
        selectedFiles = files;
        ...
        initCheckInComment(files, commitCommentList);
    ...
    {//GEN-HEADEREND:event_prevButtonActionPerformed
        ...
        if (checkInCommentIndex > 0) {
            checkInCommentIndex--;
            setChangesDescription(commitCommentList.get(checkInCommentIndex));
