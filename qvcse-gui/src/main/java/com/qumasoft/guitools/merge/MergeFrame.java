...
public class MergeFrame extends javax.swing.JFrame {
    ...
    {//GEN-HEADEREND:event_saveChangesButtonActionPerformed
        ...
        saveChanges(workFile);

        if (operationCaller != null) {
            operationCaller.updateWorkfileInfo(defaultRevisionWorkfileInfo, defaultRevisionBuffer);
        }
    ...
    {//GEN-HEADEREND:event_saveAsButtonActionPerformed
        ...
        fileDialog.setDirectory(workFile.getParent());
        ...
        if (fileDialog.getFile() != null) {
            try {
                ...
                if (0 == fileToSaveTo.getCanonicalPath().compareTo(workFile.getCanonicalPath())) {
     ...
     * @param wrkFile WorkFile for the file we are merging.
                    ...
                    case CompareFilesEditInformation.QVCS_EDIT_DELETE: {
                        ...
                        do {
                            ...
                            if (rowIterator.hasNext()) {
                                ...
                                LOGGER.warn("This was a bug, but not anymore.");
                            }
                        } while (rowIterator.hasNext());
                        break;
                    }
