...
java -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=9006 -Dapple.laf.useScreenMenuBar=true -Xmx512m -Xms512m -XX:+UseG1GC -XX:MaxGCPauseMillis=200 -Xloggc:$QVCS_HOME/logs/qvcsos-client-gc.log -Duser.name=JimVoris -jar qvcse-gui-$QVCS_VERSION.jar
