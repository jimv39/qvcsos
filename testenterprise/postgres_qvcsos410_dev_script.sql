DROP DATABASE qvcsos410dev;

DROP USER qvcsos410dev;
...
CREATE TABLE qvcsos410dev.promotion_candidate
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    file_id integer NOT NULL,
    branch_id integer NOT NULL,
...
ALTER TABLE qvcsos410dev.promotion_candidate
    OWNER to qvcsos410dev;
...
INSERT INTO qvcsos410dev.privileged_action (action_id, action_name, admin_only_flag) VALUES (8, 'Set file attributes', FALSE);
INSERT INTO qvcsos410dev.privileged_action (action_id, action_name, admin_only_flag) VALUES (9, 'Set comment prefix', FALSE);
INSERT INTO qvcsos410dev.privileged_action (action_id, action_name, admin_only_flag) VALUES (10, 'Set file description', FALSE);
INSERT INTO qvcsos410dev.privileged_action (action_id, action_name, admin_only_flag) VALUES (11, 'Set revision description', FALSE);
INSERT INTO qvcsos410dev.privileged_action (action_id, action_name, admin_only_flag) VALUES (12, 'Create archive', FALSE);
...
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (1, 8, FALSE);  -- SET FILE ATTRIBUTES
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (1, 9, FALSE);  -- SET COMMENT PREFIX
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (1, 10, FALSE); -- SET FILE DESCRIPTION
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (1, 11, FALSE); -- SET REVISION DESCRIPTION
...
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (2, 8, FALSE);  -- SET FILE ATTRIBUTES
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (2, 9, FALSE);  -- SET COMMENT PREFIX
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (2, 10, FALSE); -- SET FILE DESCRIPTION
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (2, 11, FALSE); -- SET REVISION DESCRIPTION
...
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (3, 8, FALSE);  -- SET FILE ATTRIBUTES
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (3, 9, FALSE);  -- SET COMMENT PREFIX
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (3, 10, FALSE); -- SET FILE DESCRIPTION
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (3, 11, FALSE); -- SET REVISION DESCRIPTION
...
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (4, 8, TRUE);   -- SET FILE ATTRIBUTES
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (4, 9, TRUE);   -- SET COMMENT PREFIX
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (4, 10, TRUE);  -- SET FILE DESCRIPTION
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (4, 11, TRUE);  -- SET REVISION DESCRIPTION
...
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (5, 8, TRUE);    -- SET FILE ATTRIBUTES
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (5, 9, TRUE);    -- SET COMMENT PREFIX
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (5, 10, TRUE);   -- SET FILE DESCRIPTION
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (5, 11, TRUE);   -- SET REVISION DESCRIPTION
...
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (6, 8, FALSE);   -- SET FILE ATTRIBUTES
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (6, 9, FALSE);   -- SET COMMENT PREFIX
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (6, 10, FALSE);  -- SET FILE DESCRIPTION
INSERT INTO qvcsos410dev.role_type_action_join (role_type_id, action_id, action_enabled_flag) VALUES (6, 11, FALSE);  -- SET REVISION DESCRIPTION
