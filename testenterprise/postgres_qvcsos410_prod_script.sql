...
CREATE TABLE qvcsos410prod.provisional_directory_location
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    branch_id integer NOT NULL,
    directory_id integer NOT NULL,
...
ALTER TABLE qvcsos410prod.provisional_directory_location
    OWNER to qvcsos410prod;
...
CREATE TABLE IF NOT EXISTS qvcsos410prod.filter_collection
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    user_id integer NOT NULL,
...
ALTER TABLE IF EXISTS qvcsos410prod.filter_collection
    OWNER to qvcsos410prod;

CREATE TABLE IF NOT EXISTS qvcsos410prod.filter_type
(
    id integer NOT NULL,
...
ALTER TABLE IF EXISTS qvcsos410prod.filter_type
    OWNER to qvcsos410prod;

CREATE TABLE IF NOT EXISTS qvcsos410prod.filter_file
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    ...
    CONSTRAINT filter_collection_fk FOREIGN KEY (filter_collection_id)
        REFERENCES qvcsos410prod.filter_collection (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT filter_type_fk FOREIGN KEY (filter_type_id)
        REFERENCES qvcsos410prod.filter_type (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
ALTER TABLE IF EXISTS qvcsos410prod.filter_file
    OWNER to qvcsos410prod;


CREATE TABLE IF NOT EXISTS qvcsos410prod.label
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
...
ALTER TABLE IF EXISTS qvcsos410prod.label
    OWNER to qvcsos410prod;

CREATE TABLE IF NOT EXISTS qvcsos410prod.label_file_join
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    file_id integer NOT NULL,
    ...
    CONSTRAINT label_fk FOREIGN KEY (label_id)
        REFERENCES qvcsos410prod.label (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
ALTER TABLE IF EXISTS qvcsos410prod.label_file_join
    OWNER to qvcsos410prod;

CREATE TABLE IF NOT EXISTS qvcsos410prod.label_revision_join
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    ...
    CONSTRAINT file_revision_fk FOREIGN KEY (revision_id)
        REFERENCES qvcsos410prod.file_revision (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT label_fk FOREIGN KEY (label_id)
        REFERENCES qvcsos410prod.label (id) MATCH SIMPLE
...
ALTER TABLE IF EXISTS qvcsos410prod.label_revision_join
    OWNER to qvcsos410prod;


-- Insert the ADMIN user
INSERT INTO qvcsos410prod."user" (user_name, password, deleted_flag) VALUES ('ADMIN', '\\', false);
...
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (1, 'Include Extension');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (2, 'Exclude Extension');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (3, 'Include Regular Expression Filename');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (4, 'Exclude Regular Expression Filename');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (5, 'Revision description regular expression');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (6, 'Exclude revision description regular expression');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (7, 'Include File Status');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (8, 'Exclude File Status');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (9, 'Checked in after commit id');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (10, 'Checked in before commit id');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (11, 'Filesize greater than');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (12, 'Filesize less than');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (13, 'Include last edit by');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (14, 'Exclude last edit by');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (15, 'Exclude uncontrolled files');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (16, 'Search Commit Messages');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (17, 'By Commit id');
INSERT INTO qvcsos410prod.filter_type (id, filter_type) VALUES (18, 'By Label');

-- Define built-in file filter collections.
INSERT INTO qvcsos410prod.filter_collection (user_id, built_in_flag, collection_name) VALUES (1, TRUE, 'All Files');                 -- ID 1
INSERT INTO qvcsos410prod.filter_collection (user_id, built_in_flag, collection_name) VALUES (1, TRUE, 'Search Commit Messages');    -- ID 2
INSERT INTO qvcsos410prod.filter_collection (user_id, built_in_flag, collection_name) VALUES (1, TRUE, 'By Commit id');              -- ID 3
INSERT INTO qvcsos410prod.filter_collection (user_id, built_in_flag, collection_name) VALUES (1, FALSE, 'Java source files');        -- ID 4
INSERT INTO qvcsos410prod.filter_collection (user_id, built_in_flag, collection_name) VALUES (1, FALSE, 'C++ and .h source files');  -- ID 5
INSERT INTO qvcsos410prod.filter_collection (user_id, built_in_flag, collection_name) VALUES (1, FALSE, 'Javascript files');         -- ID 6
INSERT INTO qvcsos410prod.filter_collection (user_id, built_in_flag, collection_name) VALUES (1, FALSE, 'Controlled files');         -- ID 7
INSERT INTO qvcsos410prod.filter_collection (user_id, built_in_flag, collection_name) VALUES (1, FALSE, 'Uncontrolled files');       -- ID 8
INSERT INTO qvcsos410prod.filter_collection (user_id, built_in_flag, collection_name) VALUES (1, TRUE, 'By Label');                  -- ID 9

-- Define filters associated with build-in filter collections
INSERT INTO qvcsos410prod.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (2, 16, TRUE, NULL);

INSERT INTO qvcsos410prod.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (3, 17, TRUE, NULL);

INSERT INTO qvcsos410prod.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (4, 1, TRUE, 'java');

INSERT INTO qvcsos410prod.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (5, 1, FALSE, 'cpp');
INSERT INTO qvcsos410prod.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (5, 1, FALSE, 'h');

INSERT INTO qvcsos410prod.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (6, 1, TRUE, 'js');

INSERT INFO qvcsos410prod.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (7, 8, TRUE, 'Not controlled');

INSERT INFO qvcsos410prod.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (8, 7, TRUE, 'Not controlled');

INSERT INTO qvcsos410prod.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (9, 15, TRUE, NULL);
