...
//
// $Filename: C:\qRoot\testQVCSWorkfiles\Remote Secure Java Project\QumaProjects\com\qumasoft\client\TestCheckInAgainArchive.java $
//     $Date: Monday, January 06, 2003 9:51:00 PM $
// $Revision: 1.54 $
//
...
// 
// Revision 1.52  by: JimVoris  Rev date: 1/4/2003 2:36:22 PM
//   Change so that conversion to get workfile name figures out what to use as the path separator.
// 
// Revision 1.51  by: JimVoris  Rev date: 12/17/2002 10:49:52 PM
//   Change for the signature change of getDefaultRevisionHeader.
// 
// Revision 1.50  by: JimVoris  Rev date: 12/16/2002 8:43:24 AM
//   Add getLockedByString() method so local projects display the same locked by string as remote projects.
//   
// 
// $Endlog$
//
...
class LogFileImpl
{
    ...
    String getLockedRevisionString(String userName)
    {
        ...
        AccessList modifierList = new AccessList("Joe,Ralph");
