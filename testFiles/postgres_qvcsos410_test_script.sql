DROP DATABASE IF EXISTS qvcsos410test;

DROP USER IF EXISTS qvcsos410test;
...
AS $BODY$
BEGIN
    INSERT INTO qvcsos410test.file_name_history(file_name_id, branch_id, directory_id, file_id, created_for_reason, commit_id, file_name, promoted_flag, deleted_flag, promotion_commit_id)
...
CREATE TABLE qvcsos410test.provisional_directory_location
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    branch_id integer NOT NULL,
    directory_id integer NOT NULL,
...
ALTER TABLE qvcsos410test.provisional_directory_location
    OWNER to qvcsos410test;
...
CREATE TABLE IF NOT EXISTS qvcsos410test.user_properties
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
...
ALTER TABLE IF EXISTS qvcsos410test.user_properties
    OWNER to qvcsos410test;
...
ALTER TABLE IF EXISTS qvcsos410test.view_utility_command_line
    OWNER to qvcsos410test;
...
ALTER TABLE IF EXISTS qvcsos410test.view_utility_by_extension
    OWNER to qvcsos410test;

CREATE TABLE IF NOT EXISTS qvcsos410test.filter_collection
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    user_id integer NOT NULL,
...
ALTER TABLE IF EXISTS qvcsos410test.filter_collection
    OWNER to qvcsos410test;

CREATE TABLE IF NOT EXISTS qvcsos410test.filter_type
(
    id integer NOT NULL,
...
ALTER TABLE IF EXISTS qvcsos410test.filter_type
    OWNER to qvcsos410test;

CREATE TABLE IF NOT EXISTS qvcsos410test.filter_file
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    ...
    CONSTRAINT filter_collection_fk FOREIGN KEY (filter_collection_id)
        REFERENCES qvcsos410test.filter_collection (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT filter_type_fk FOREIGN KEY (filter_type_id)
        REFERENCES qvcsos410test.filter_type (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
ALTER TABLE IF EXISTS qvcsos410test.filter_file
    OWNER to qvcsos410test;

CREATE TABLE IF NOT EXISTS qvcsos410test.label
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
...
ALTER TABLE IF EXISTS qvcsos410test.label
    OWNER to qvcsos410test;

CREATE TABLE IF NOT EXISTS qvcsos410test.label_file_join
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    file_id integer NOT NULL,
    ...
    CONSTRAINT label_fk FOREIGN KEY (label_id)
        REFERENCES qvcsos410test.label (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
ALTER TABLE IF EXISTS qvcsos410test.label_file_join
    OWNER to qvcsos410test;

CREATE TABLE IF NOT EXISTS qvcsos410test.label_revision_join
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    ...
    CONSTRAINT file_revision_fk FOREIGN KEY (revision_id)
        REFERENCES qvcsos410test.file_revision (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT label_fk FOREIGN KEY (label_id)
        REFERENCES qvcsos410test.label (id) MATCH SIMPLE
...
ALTER TABLE IF EXISTS qvcsos410test.label_revision_join
    OWNER to qvcsos410test;


-- Insert the ADMIN user
INSERT INTO qvcsos410test."user" (user_name, password, deleted_flag) VALUES ('ADMIN', '\\', false);
...
INSERT INTO qvcsos410test.privileged_action (action_id, action_name, admin_only_flag) VALUES (12, 'Add file', FALSE);
...
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (1, 'Include Extension');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (2, 'Exclude Extension');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (3, 'Include Regular Expression Filename');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (4, 'Exclude Regular Expression Filename');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (5, 'Revision description regular expression');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (6, 'Exclude revision description regular expression');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (7, 'Include File Status');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (8, 'Exclude File Status');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (9, 'Checked in after commit id');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (10, 'Checked in before commit id');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (11, 'Filesize greater than');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (12, 'Filesize less than');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (13, 'Include last edit by');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (14, 'Exclude last edit by');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (15, 'Exclude uncontrolled files');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (16, 'Search Commit Messages');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (17, 'By Commit id');
INSERT INTO qvcsos410test.filter_type (id, filter_type) VALUES (18, 'By Label');
...
INSERT INTO qvcsos410test.filter_collection (user_id, built_in_flag, collection_name) VALUES (1, FALSE, 'Controlled files');         -- ID 7
INSERT INTO qvcsos410test.filter_collection (user_id, built_in_flag, collection_name) VALUES (1, FALSE, 'Uncontrolled files');       -- ID 8
INSERT INTO qvcsos410test.filter_collection (user_id, built_in_flag, collection_name) VALUES (1, TRUE, 'By Label');                  -- ID 9

-- Define filters associated with build-in filter collections
INSERT INTO qvcsos410test.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (2, 16, TRUE, NULL);

INSERT INTO qvcsos410test.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (3, 17, TRUE, NULL);

INSERT INTO qvcsos410test.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (4, 1, TRUE, 'java');

INSERT INTO qvcsos410test.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (5, 1, FALSE, 'cpp');
INSERT INTO qvcsos410test.filter_file (filter_collection_id, filter_type_id, is_and_flag, filter_data) VALUES (5, 1, FALSE, 'h');
