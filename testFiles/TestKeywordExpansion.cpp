 ...
 * characters after that (including the ending qvcsKEYWORD_PREFIX character). $Comment: This is the first comment.$
 */
static int locExpandKeyWords
(
    char                        *pcBuf,
...
/*
 *  l o c E x p a n d L o g $Comment: this is a middle comment.$
 *
