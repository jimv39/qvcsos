 ...
 * @author Jim Voris
 */
public class RepairCompareFilesEditInformation {
    // Create our logger object
    private static final Logger LOGGER = LoggerFactory.getLogger(RepairCompareFilesEditInformation.class);
    /**
    ...
    private final RepairCommonShort editType = new RepairCommonShort();
    private final RepairCommon32Long seekPosition = new RepairCommon32Long();
    private final RepairCommon32Long deletedBytesCount = new RepairCommon32Long();
    private final RepairCommon32Long insertedBytesCount = new RepairCommon32Long();

    /**
     * Default constructor.
     */
    public RepairCompareFilesEditInformation() {
    }
     ...
     */
    public RepairCompareFilesEditInformation(short type, int seekPos, int deletedCount, int insertedCount) {
