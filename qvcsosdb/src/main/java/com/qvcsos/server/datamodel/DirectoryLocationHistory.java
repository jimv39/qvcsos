 ...
 * @author Jim Voris
 */
public class DirectoryLocationHistory {
    private Integer directoryLocationHistoryId;
    ...
    public Integer getId() {
        return directoryLocationHistoryId;
    }
    ...
    public void setId(Integer id) {
        this.directoryLocationHistoryId = id;
    }
    ...
    /**
     * @param id the directoryLocationId to set
     */
    public void setDirectoryLocationId(Integer id) {
    ...
    /**
     * @param name the directorySegmentName to set
     */
    public void setDirectorySegmentName(String name) {
        this.directorySegmentName = name;
    }
