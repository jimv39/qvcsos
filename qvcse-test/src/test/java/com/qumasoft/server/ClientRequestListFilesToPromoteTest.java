...
//   $Header: ClientRequestListFilesToPromoteTest.java Revision:1.3 Wednesday, March 21, 2012 10:31:03 PM JimVoris $
 ...
 */
public class ClientRequestListFilesToPromoteTest {
     ...
     * Default constructor.
     */
    public ClientRequestListFilesToPromoteTest() {
    }
    ...
    public void testExecute() {
        ...
        if (serializableObjectInterface instanceof ServerResponseListFilesToPromote) {
            ServerResponseListFilesToPromote serverResponseListFilesToPromote = (ServerResponseListFilesToPromote) serializableObjectInterface;
    ...
    private void checkInRevisionForBranch() {
        ...
        SerializableObjectInterface serializableObjectInterface = clientRequestCheckIn.execute(TestHelper.USER_NAME, bogusResponseObject);
        ServerTransactionManager.getInstance().clientEndTransaction(bogusResponseObject);
        if (serializableObjectInterface instanceof ServerResponseCheckIn) {
            ServerResponseCheckIn serverResponseCheckIn = (ServerResponseCheckIn) serializableObjectInterface;
