...
//   $Header: ArchiveInfoForTranslucentBranchTest.java Revision:1.3 Wednesday, March 21, 2012 10:31:02 PM JimVoris $
 ...
 * @author JimVoris
 */
public class ArchiveInfoForTranslucentBranchTest {
     ...
     * Default ctor.
     */
    public ArchiveInfoForTranslucentBranchTest() {
    }
    ...
    public void setUp() {
        ...
        archiveInfoForTranslucentBranch = new ArchiveInfoForTranslucentBranch(getBranchFileName(), testArchive, translucentBranchProperties, null);
    ...
    public void testGetDefaultRevisionDigest() {
        ...
        assertEquals("Unexpected default revision digest", expResult, result);
    }
    ...
    public void testGetLogfileInfo() {
        ...
        assertTrue(result.getLogFileHeaderInfo().getLogFileHeader().m_Attributes.getIsCheckLock() == false);
    }
    ...
    public void testCheckInRevision() throws Exception {
        ...
        assertTrue(0 == tipRevision.compareTo("1.91.1.1"));
        assertEquals(expResult, result);
        assertEquals(0, instance.getLockCount());
    ...
    public void testLockChildBranchRevision() throws Exception {
        ...
        // Keep track that we're in a transaction.
        ServerTransactionManager.getInstance().clientBeginTransaction(bogusResponseObject);
        ArchiveDirManagerInterface archiveDirManager = ArchiveDirManagerFactoryForServer.getInstance().getDirectoryManager(QVCSConstants.QVCS_SERVER_SERVER_NAME, getProjectName(), getChildBranchName(), "",
                QVCSConstants.QVCS_SERVED_PROJECT_TYPE, QVCSConstants.QVCS_SERVER_USER, bogusResponseObject, true);
        ArchiveInfoForTranslucentBranch instance = (ArchiveInfoForTranslucentBranch) archiveDirManager.getArchiveInfo(getShortWorkfileName());
        boolean expResult = false;
        boolean result = instance.lockRevision(commandArgs);
