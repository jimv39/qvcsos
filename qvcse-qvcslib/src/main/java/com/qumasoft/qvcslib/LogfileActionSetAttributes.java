 ...
 * @author Jim Voris
 */
public class LogfileActionSetAttributes extends LogfileActionType {
     ...
     */
    public LogfileActionSetAttributes(ArchiveAttributes attribs) {
        super("Set Attributes", LogfileActionType.SET_ATTRIBUTES);
        attributes = attribs;
    }
