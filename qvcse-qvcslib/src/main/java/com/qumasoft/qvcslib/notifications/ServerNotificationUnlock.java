 ...
 * @author Jim Voris
 */
public class ServerNotificationUnlock implements ServerNotificationInterface {
    private static final long serialVersionUID = -569865840325214867L;
     ...
     */
    public ServerNotificationUnlock() {
    }
    ...
    public NotificationType getNotificationType() {
        return NotificationType.SR_NOTIFY_UNLOCK;
    }
}
