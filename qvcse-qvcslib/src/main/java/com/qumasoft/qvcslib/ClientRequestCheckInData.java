...
public class ClientRequestCheckInData extends ClientRequestClientData {
    ...
    private int index;
    private LogFileOperationCheckInCommandArgs commandArgs;
     ...
     */
    public LogFileOperationCheckInCommandArgs getCommandArgs() {
        return commandArgs;
    }
     ...
     */
    public void setCommandArgs(LogFileOperationCheckInCommandArgs args) {
        commandArgs = args;
    }
