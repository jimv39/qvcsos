 ...
 * @author Jim Voris
 */
public class ClientRequestApplyTagData extends ClientRequestClientData {
    ...
    public RequestOperationType getOperationType() {
        return RequestOperationType.APPLY_TAG;
    }
    ...
    /**
     * @param flag the moveableTagFlag to set
     */
    public void setMoveableTagFlag(Boolean flag) {
        this.moveableTagFlag = flag;
    }
