 ...
 * @author Jim Voris
 */
public class ServerResponseLock implements ServerResponseInterface {
    private static final long serialVersionUID = 8645784512782234069L;
     ...
     * @param clientWorkName the client workfile name.
     */
    public void setClientWorkfileName(String clientWorkName) {
        clientWorkfileName = clientWorkName;
    }
    ...
    public void updateDirManagerProxy(ArchiveDirManagerProxy directoryManagerProxy) {
        StringBuilder message = new StringBuilder("Locked revision ");
    ...
    public ResponseOperationType getOperationType() {
        return ResponseOperationType.SR_LOCK;
    }
}
