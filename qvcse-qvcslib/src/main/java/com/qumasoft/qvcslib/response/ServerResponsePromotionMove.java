 ...
 * @author Jim Voris
 */
public class ServerResponsePromotionMove extends AbstractServerResponsePromoteFile {
    private static final Logger LOGGER = LoggerFactory.getLogger(ServerResponsePromotionMove.class);
    ...
    public ResponseOperationType getOperationType() {
        return ResponseOperationType.SR_PROMOTE_FILE_MOVE;
    }

    @Override
    public void updateDirManagerProxy(ArchiveDirManagerProxy directoryManagerProxy) {
        String message = String.format("ServerResponsePromotionMove promoted file from location: [%s/%s] to location [%s/%s]",
