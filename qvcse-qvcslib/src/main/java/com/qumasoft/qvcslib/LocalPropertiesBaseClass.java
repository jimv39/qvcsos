...
/**
 * Local Properties. These values are in a local property file.
 *
 * @author Jim Voris.
 */
public abstract class LocalPropertiesBaseClass {
    private java.util.Properties actualProperties;
    private String propertyFileName;
    private final Object propertySyncObject = new Object();

    /**
     * Creates new LocalPropertiesBaseClass.
     */
    public LocalPropertiesBaseClass() {
    }
