 ...
 * @author Jim Voris
 */
public final class LogFileOperationSetRevisionDescriptionCommandArgs implements java.io.Serializable {
     ...
     */
    public LogFileOperationSetRevisionDescriptionCommandArgs() {
    }
