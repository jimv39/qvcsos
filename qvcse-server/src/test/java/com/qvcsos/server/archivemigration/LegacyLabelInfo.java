 ...
 * @author Jim Voris
 */
public class LegacyLabelInfo {

    // Create our logger object
    private static final Logger LOGGER = LoggerFactory.getLogger(LegacyLabelInfo.class);
    private LegacyCommonShort revisionCount = new LegacyCommonShort();
    private LegacyCommonShort creatorIndex = new LegacyCommonShort();
    private LegacyCommonShort labelStringSize = new LegacyCommonShort();
     ...
     * @param floatingFlag floating label flag; true if this is to be a floating
     * label; false otherwise.
     * @param creatorIdx the creator index.
     */
    public LegacyLabelInfo(String label, String revisionString, boolean floatingFlag, int creatorIdx) {
        ...
        // got.
        labelRevInfo = new LegacyLabelInfo.LabelRevisionInfo(revisionString, floatingFlag);
     ...
     *
     * @param flag true to indicate this is an obsolete label; false to clear
     * the obsolete-ness of this label.
     * @param creatorIdx the creator index of the user performing this
     * operation.
     * @deprecated we don't use this anymore -- at least we shouldn't be using
     * it any more.
     */
    ...
    /**
     * Get a sortable revision string for the revision associated with this
     * label.
     *
     * @return a sortable revision string for the revision associated with this
     * label.
     */
    ...
    /**
     * Get the major/minor pairs that describe the revision associated with this
     * label.
     *
     * @return the major/minor pairs that describe the revision associated with
     * this label.
     */
    ...
    public class LabelRevisionInfo implements Serializable {
         ...
         *
         * @return true if this is the special 'obsolete' label, false
         * otherwise.
        ...
        /**
         * Get the number of major/minor pairs that are needed to describe the
         * revision associated with this label. TODO -- this is a lousy name for
         * this method.
         *
         * @return the number of major/minor pairs that are needed to describe
         * the revision associated with this label.
         */
    ...
    public class LabelMajorMinor implements Serializable {
        ...
        /**
         * A useful string representation of the label's major/minor revision
         * info.
         *
         * @return a useful string representation of the label's major/minor
         * revision info.
         */
        @Override
        public String toString() {
