 ...
 * @author Jim Voris
 */
public class LegacySupplementalHeaderInfo {
    // Create our logger object

    private static final Logger LOGGER = LoggerFactory.getLogger(LegacySupplementalHeaderInfo.class);
     ...
     */
    public LegacySupplementalHeaderInfo() {
        supplementalInfo = new byte[LegacyQVCSConstants.QVCS_SUPPLEMENTAL_SIZE];
     ...
     */
    public LegacySupplementalHeaderInfo(int bufferSize) {
        supplementalInfo = new byte[bufferSize];
    }

    /**
     * A sort of copy constructor where we create a new SupplementalHeaderInfo
     * object using the buffer we pass in.
     *
     * @param supplementInfo the existing supplementalInfo buffer.
     */
    public LegacySupplementalHeaderInfo(final byte[] supplementInfo) {
    ...
    private void adjustBufferSize() {
        if (supplementalInfo.length != LegacyQVCSConstants.QVCS_SUPPLEMENTAL_SIZE) {
            byte[] newSupplementalInfo = new byte[LegacyQVCSConstants.QVCS_SUPPLEMENTAL_SIZE];
