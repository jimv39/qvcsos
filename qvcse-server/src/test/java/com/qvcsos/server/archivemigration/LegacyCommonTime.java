 ...
 * @author Jim Voris
 */
public class LegacyCommonTime {
    /**
     * The internal long value for the time_t value, converted to the Java
     * representation.
     */
    private final LegacyCommon32Long timeValue;
    private static final long MILLISECONDS_PER_SECOND = 1000L;

    /**
     * Default constructor. Default the time to now.
     */
    public LegacyCommonTime() {
        Date now = new Date();
        this.timeValue = new LegacyCommon32Long((int) (now.getTime() / MILLISECONDS_PER_SECOND));
    }
     ...
     */
    public LegacyCommonTime(int value) {
        this.timeValue = new LegacyCommon32Long(value);
    }
