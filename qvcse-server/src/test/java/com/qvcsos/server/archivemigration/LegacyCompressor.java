 ...
 * @author jimv
 */
public interface LegacyCompressor {

    /**
     * Compress a buffer.
     *
     * @param inputBuffer the input buffer.
     * @return true if compression succeeded in producing something smaller than
     * what was passed in; false otherwise.
     */
     ...
     * @param inputBuffer the compressed buffer, including the
     * RevisionCompressionHeader at its start.
     * @return the expanded, uncompressed buffer.
     */
    byte[] expand(LegacyRevisionCompressionHeader compressionHeader, byte[] inputBuffer);

    /**
     * Expand a compressed buffer.
     *
     * @param inputBuffer the compressed buffer that includes the
     * RevisionCompressionHeader at its start.
     * @return the expanded, uncompressed buffer.
     */
