...
/**
 * File data model class. Each instance represents a file that's under version control.
 *
 * @author Jim Voris
 */
public class File {
    /*
     * The SQL snippet used to create the File table:
     * FILE_ID INT NOT NULL, BRANCH_ID INT NOT NULL, DIRECTORY_ID INT NOT NULL, FILE_NAME VARCHAR(256) NOT NULL,
     * INSERT_DATE TIMESTAMP NOT NULL, UPDATE_DATE TIMESTAMP NOT NULL, DELETED_FLAG CHAR(1) NOT NULL
     */
