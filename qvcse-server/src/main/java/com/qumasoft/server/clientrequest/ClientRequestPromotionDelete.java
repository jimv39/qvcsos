 ...
 * @author Jim Voris
 */
public class ClientRequestPromotionDelete extends AbstractClientRequestPromoteFile {

    ClientRequestPromotionDelete(ClientRequestPromoteFileData data) {
        super(data);
    }
    ...
    AbstractServerResponse executePromotion(String userName, DirectoryCoordinate fbDirectoryCoordinates, DirectoryCoordinate pbDirectoryCoordinates, DirectoryCoordinateIds fbDcIds,
        ...
        handleDeletePromotion(pbDcIds, filePromotionInfo, serverResponsePromotionDelete);
        String removeShortFileName = filePromotionInfo.getPromotedFromShortWorkfileName();
        SkinnyLogfileInfo promotedFromSkinnyInfo = serverResponsePromotionDelete.getPromotedFromSkinnyLogfileInfo();
    ...
    private void handleDeletePromotion(DirectoryCoordinateIds pbDcIds, FilePromotionInfo filePromotionInfo,
            ServerResponsePromotionDelete serverResponsePromotionDelete) throws QVCSException {
        FunctionalQueriesDAO functionalQueriesDAO = new FunctionalQueriesDAOImpl(getSchemaName());
        ...
        serverResponsePromotionDelete.setLogfileInfo(logfileInfo);
        ...
        serverResponsePromotionDelete.setPromotedFromSkinnyLogfileInfo(promotedFromSkinnyInfo);
    }
