 ...
 * @author Jim Voris
 */
public class ClientRequestAddLabel extends AbstractClientRequest {
    /**
     * Create our logger.
     */
    ...
    public ClientRequestAddLabel(ClientRequestAddLabelData data) {
    ...
    public ServerResponseInterface execute(String userName, ServerResponseFactoryInterface response) {
        ...
        try {
            ...
            Integer labelId = labelDAO.insert(label);
            label.setLabelId(labelId);
            DatabaseManager.getInstance().getConnection().commit();

            LOGGER.info("Added label: [{}] with id: [{}]", labelText, labelId);

            // Send back new list of labels.
