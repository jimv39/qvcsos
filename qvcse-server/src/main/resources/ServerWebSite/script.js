...
function menuWrite(){
    ...
    ff += '<li class="sublist"><a class="list" href="docs/understandingTags.html">Tags<\/a><\/li>';
    ff += '<li class="sublist"><a class="list" href="docs/understandingBranches.html">Branches<\/a><\/li>';
    ff+='<li class="sublist"><a class="list" href="docs/understandingRolesAndActions.html">Roles and Actions<\/a><\/li>';
    ff += '<li class="sublist"><a class="list" href="docs/understandingIgnoringFiles.html">Ignoring files<\/a><\/li>';
    ff+='<\/ul><\/li>';
    ...
    ie += '<li class="esublist"><a class="list" href="docs/understandingTags.html">Tags<\/a><\/li>';
    ie += '<li class="esublist"><a class="list" href="docs/understandingBranches.html">Branches<\/a><\/li>';
    ie+='<li class="esublist"><a class="list" href="docs/understandingRolesAndActions.html">Roles and Actions<\/a><\/li>';
    ie += '<li class="esublist"><a class="list" href="docs/understandingIgnoringFiles.html">Ignoring files<\/a><\/li>';
    ie += '<\/ul><\/li>';
